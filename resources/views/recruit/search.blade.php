...
@section('title', '検索結果 - ' . config('app.name'))
...
<h2>検索結果<span style="font-size: 18px; margin-left: 20px;">{{ $recruits->total() }}件</span><span class="d-none d-sm-block" style="font-size: 18px; font-weight: normal; display: block; text-align: right; margin-top: -20px;">{{ $from }}件〜{{ $to }}件を表示</span></h2>
